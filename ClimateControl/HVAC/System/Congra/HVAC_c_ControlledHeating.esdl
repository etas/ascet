...
/**
 * Esdl /resource/HVAC/src-gen/System/ControlledHeating.syq for the system HVAC_c_ControlledHeating
 * Source File Path: class
 */
class HVAC_c_ControlledHeating {
	...
	/**
	 * Begin Esdl Method for computation for: c_ControlledHeating
	 * Source file: /resource/HVAC/src-gen/System/ControlledHeating.syq
	 */
	public void c_ControlledHeating__Initial(){
		heatFlowRate_Heater = 0.25;
		heatFlowRate_Cooler = 0.0;
	}
	public void c_ControlledHeating__Method(){
	...
	public void c_ControlledHeating_integrate(){
		// call the flow 
		c_ControlledHeating__Method();
		// integration and delay variables
		//integrate(heatFlow_InteriorIntegrated, heatFlow_Interior);
		heatFlow_InteriorIntegrated = heatFlow_InteriorIntegrated + heatFlow_Interior;
	}
	 /**
	 * End Esdl Method for computation for: c_ControlledHeating
	 */

	@no_side_effect
	private real integrate(real inout x, real in xdot){
		real step = 1.0;
		x = x + xdot*step;
		return x;
	}
