...
/**
 * Esdl /resource/Example/src-gen/System/Heat.syq for the system InteriorModel_c_Heat
 * Source File Path: class
 */
class InteriorModel_c_Heat {
	...
	/**
	 * Begin Esdl Method for computation for: c_Heat
	 * Source file: /resource/Example/src-gen/System/Heat.syq
	 */
	public void c_Heat__Initial(){
		cooler_active = 0.0;
		heater_active = 1.0;
		ControllerHeater.P = 0.7;
		ControllerHeater.I = 0.05;
	}
	void c_Heat__Method(){
		...
		ControllerHeater.difference_dot += ControllerHeater.difference;
	...
	/*
	 * End Esdl Method for computation for: c_Heat
	 */
