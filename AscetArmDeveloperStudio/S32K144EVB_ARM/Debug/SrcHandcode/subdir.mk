...
SrcHandcode/%.o: ../SrcHandcode/%.s
	...
	armclang.exe --target=arm-arm-none-eabi -mcpu=cortex-m4 -mfpu=none -mfloat-abi=soft -mthumb -g3 -c -o "$@" "$<"
...
SrcHandcode/%.o: ../SrcHandcode/%.c
	...
	armclang.exe --target=arm-arm-none-eabi -mcpu=cortex-m4 -mfpu=none -mfloat-abi=soft -mthumb -I"C:\work\DSworkspaces\S32K144_ArmIDE_ASCET\S32K144EVB_ARM\include" -O2 -g3 -MD -MP -c -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
