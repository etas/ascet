...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'IN_CANCONFIG_EVB_initCANChannel'
 * ----------------------------------------------------------------------------
 * model name:...................................'initCANChannel'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public initCANChannel (IN_Channel::udisc;IN_Baud::udisc)  */

void IN_CANCONFIG_EVB_initCANChannel (
   /* IN    */ uint8  IN_Channel,
   /* IN    */ uint16 IN_Baud
   )
{
   ...
   /* initCANChannel 4    */
#ifdef S32K144EVB
   /* initCANChannel 6    */	switch (   IN_Baud )
   /* initCANChannel 7    */		{
   /* initCANChannel 8    */			case 125:
   /* initCANChannel 9    */				HA_CANInitialiseBus(   IN_Channel , CAN_125KBPS);
   /* initCANChannel 10   */			break;
   /* initCANChannel 11   */			case 250:
   /* initCANChannel 12   */				HA_CANInitialiseBus(   IN_Channel , CAN_250KBPS);
   /* initCANChannel 13   */			break;
   /* initCANChannel 14   */			case 500:
   /* initCANChannel 15   */				HA_CANInitialiseBus(   IN_Channel , CAN_500KBPS);
   /* initCANChannel 16   */			break;
   /* initCANChannel 17   */			case 1000:
   /* initCANChannel 18   */				HA_CANInitialiseBus(   IN_Channel , CAN_1MBPS);
   /* initCANChannel 19   */			break;
   /* initCANChannel 20   */			default:
   /* initCANChannel 21   */			break;
   /* initCANChannel 22   */		}
#endif
   /* initCANChannel 24   */
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'IN_CANCONFIG_EVB_initCANChannel'
 ******************************************************************************/
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'IN_CANCONFIG_EVB_startCANChannel'
 * ----------------------------------------------------------------------------
 * model name:...................................'startCANChannel'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public startCANChannel (IN_Channel::udisc)  */

void IN_CANCONFIG_EVB_startCANChannel (/* IN    */ uint8 IN_Channel)
{
...
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'IN_CANCONFIG_EVB_startCANChannel'
 ******************************************************************************/
