...
#define _LIB_Counter (self->LIB_4BITCOUNT_EVB_IRAM->LIB_Counter)
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'LIB_4BITCOUNT_EVB_LIB_4BitCount'
 * ----------------------------------------------------------------------------
 * model name:...................................'LIB_4BitCount'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public LIB_4BitCount (LIB_Reset::log) return::udisc  */

uint8 LIB_4BITCOUNT_EVB_LIB_4BitCount (
   ...
   )
{
   ...
   /* LIB_4BitCount: source line #9:  LIB_Counter = (if((LIB_Counter == 15) || LIB_Reset) then 0 else(LIB_Counter + 1));  */
   _t1uint8
      = (((_LIB_Counter == 15U) || LIB_Reset) ? 0U : ((_LIB_Counter) + (uint8)((uint8)1U)));
   /* assignment to LIB_Counter: min=0, max=15, hex=1phys+0, limit=(maxBitLength: false, assign: true), zero incl.=true  */
   _LIB_Counter = ((_t1uint8 <= 15U /* always true */) ? _t1uint8 : 15U);
   /* LIB_4BitCount: source line #10:  return LIB_Counter;  */
   /* return with expr from LIB_4BitCount: min=0, max=15, hex=1phys+0, limit=(maxBitLength: false, assign: true), zero incl.=true  */
   return _LIB_Counter;
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'LIB_4BITCOUNT_EVB_LIB_4BitCount'
 ******************************************************************************/
