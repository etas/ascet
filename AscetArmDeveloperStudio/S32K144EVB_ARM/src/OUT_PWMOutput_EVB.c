...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'OUT_PWMOUTPUT_EVB_setPWMOut'
 * ----------------------------------------------------------------------------
 * model name:...................................'setPWMOut'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public setPWMOut (port::S32K144_Gpio;duty::cont;freq::cont)  */

void OUT_PWMOUTPUT_EVB_setPWMOut (
   /* IN    */ uint8  port,
   /* IN    */ uint16 duty,
   /* IN    */ uint16 freq
   )
...
#ifdef PC
   /* setPWMOut 2    */return(1);
#else
   /* setPWMOut 4    */	HA_SetPWM(   port ,    freq ,    duty );
#endif
   /* setPWMOut 6    */
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'OUT_PWMOUTPUT_EVB_setPWMOut'
 ******************************************************************************/
