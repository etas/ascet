...
#define _APP_INVERTDUTY (self->APP_LIGHTDUTYSWITCH_EVB_EFLASH->APP_INVERTDUTY)
#define _APP_LIGHTOFFNOBACKDUTY (self->APP_LIGHTDUTYSWITCH_EVB_EFLASH->APP_LIGHTOFFNOBACKDUTY)
#define _APP_LIGHTOFFWITHBACKDUTY (self->APP_LIGHTDUTYSWITCH_EVB_EFLASH->APP_LIGHTOFFWITHBACKDUTY)
#define _APP_LIGHTONNOBACKDUTY (self->APP_LIGHTDUTYSWITCH_EVB_EFLASH->APP_LIGHTONNOBACKDUTY)
#define _APP_LIGHTONWITHBACKDUTY (self->APP_LIGHTDUTYSWITCH_EVB_EFLASH->APP_LIGHTONWITHBACKDUTY)
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'APP_LIGHTDUTYSWITCH_EVB_APP_LightDuty'
 * ----------------------------------------------------------------------------
 * model name:...................................'APP_LightDuty'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public APP_LightDuty (APP_SwitchState::udisc;APP_FlashDuty::cont;APP_Backlight::log;APP_TCMOkay::log) return::cont  */

uint16 APP_LIGHTDUTYSWITCH_EVB_APP_LightDuty (
   ...
   )
{
   ...
   /* APP_LightDuty: line #2  */
   _t1uint16
      = ((APP_SwitchState == 3U) ? 100U : (((APP_TCMOkay && (APP_SwitchState != 0U)) ? (((APP_Backlight) ? (((APP_SwitchState == 1U) ? _APP_LIGHTOFFWITHBACKDUTY : _APP_LIGHTONWITHBACKDUTY)) : (((APP_SwitchState == 1U) ? _APP_LIGHTOFFNOBACKDUTY : _APP_LIGHTONNOBACKDUTY)))) : APP_FlashDuty)));
   /* return with expr from APP_LightDuty: min=0, max=10000, hex=100phys+0, limit=(maxBitLength: true, assign: true), zero incl.=true  */
   return ((_APP_INVERTDUTY) ? ((uint16)((uint16)10000U) - (_t1uint16)) : _t1uint16);
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'APP_LIGHTDUTYSWITCH_EVB_APP_LightDuty'
 ******************************************************************************/
