...
#include "OUT_DigitalOutput_EVBH.h"
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'OUT_DIGITALOUTPUT_EVB_setDigOut'
 * ----------------------------------------------------------------------------
 * model name:...................................'setDigOut'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public setDigOut (port::S32K144_Gpio;stat::log)  */

void OUT_DIGITALOUTPUT_EVB_setDigOut (
   /* IN    */ uint8   port,
   /* IN    */ boolean stat
   )
{
...
#ifdef PC
   /* setDigOut 2    */return(1);
#endif
   /* setDigOut 4    */
   /* setDigOut 5    */
#ifdef S32K144EVB
   /* setDigOut 7    */	HA_SetGPIOOut(   port ,   stat );
#endif
   /* setDigOut 9    */
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'OUT_DIGITALOUTPUT_EVB_setDigOut'
 ******************************************************************************/
