...
#include "IN_CANMessageInit_EVBH.h"
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'IN_CANMESSAGEINIT_EVB_initCANMsg'
 * ----------------------------------------------------------------------------
 * model name:...................................'initCANMsg'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public initCANMsg (IN_CANChannel::udisc;IN_CANID::udisc;IN_TxMsg::log;IN_ExtendedMsg::log;IN_MsgLength::udisc) return::sdisc  */

sint8 IN_CANMESSAGEINIT_EVB_initCANMsg (
...
#ifdef PC
   /* initCANMsg 2    */return(1);
#else
   /* initCANMsg 4    */sint8 handleret;
   /* initCANMsg 5    */
   /* initCANMsg 6    *//* Attempt to get a handle for a CAN message being initialised */
   /* initCANMsg 7    */	handleret = HA_CANInitialiseMessage(((   IN_TxMsg  == true)?HA_CANTXMESSAGE:HA_CANRXMESSAGE),    IN_CANChannel , ((   IN_ExtendedMsg  == true)?HA_CANEXTENDEDID:HA_CANSTANDARDID),    IN_MsgLength ,    IN_CANID );
   /* initCANMsg 8    */
   /* initCANMsg 9    */return (handleret);
#endif
   /* initCANMsg 11   */
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'IN_CANMESSAGEINIT_EVB_initCANMsg'
 ******************************************************************************/
