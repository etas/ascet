...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'OUT_CANTXLEVER_EVB_txCANMsg'
 * ----------------------------------------------------------------------------
 * model name:...................................'txCANMsg'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public txCANMsg (OUT_CANTxHandle::sdisc;OUT_CANTxMsg::T_CANLeverTCM) return::H_Status  */

uint8 OUT_CANTXLEVER_EVB_txCANMsg (
   ...
   )
{
   ...
   /* txCANMsg 6    */uint8 crc;
   /* txCANMsg 7    */
   /* txCANMsg 8    */	/* Initialised, and handle was good? */
   /* txCANMsg 9    */	if (   OUT_CANTxHandle  != HA_CANNOHANDLE)
   /* txCANMsg 10   */		{
   /* txCANMsg 11   */			/* Populate the CAN frame, with '1' in unused bits */
   /* txCANMsg 12   */			msg[0] = (   OUT_CANTxMsg->LVR_ParkSwitch << 6) | (   OUT_CANTxMsg->LVR_ReverseSwitch << 4) | (   OUT_CANTxMsg->LVR_NeutralSwitch << 2) | (   OUT_CANTxMsg->LVR_DriveSwitch);
   /* txCANMsg 13   */			msg[1] = (   OUT_CANTxMsg->LVR_SportSwitch << 6) | (   OUT_CANTxMsg->LVR_ManualSwitch << 4) | (   OUT_CANTxMsg->LVR_PlusSwitch << 2) | (   OUT_CANTxMsg->LVR_MinusSwitch);
   /* txCANMsg 14   */			msg[2] =    OUT_CANTxMsg->LVR_TestResponse;
   /* txCANMsg 15   */			msg[3] = 0xFF;
   /* txCANMsg 16   */			msg[4] = 0xFF;
   /* txCANMsg 17   */			msg[5] = 0xFF;
   /* txCANMsg 18   */			msg[6] = 0xF0 |    OUT_CANTxMsg->LVR_Counter;
   /* txCANMsg 19   */			/* Calculate a simple checksum */
   /* txCANMsg 20   */			crc = (uint8)0xFF ^ msg[0];
   /* txCANMsg 21   */			crc = crc ^ msg[1];
   /* txCANMsg 22   */			crc = crc ^ msg[2];
   /* txCANMsg 23   */			crc = crc ^ msg[3];
   /* txCANMsg 24   */			crc = crc ^ msg[4];
   /* txCANMsg 25   */			crc = crc ^ msg[5];
   /* txCANMsg 26   */			crc = crc ^ msg[6];
   /* txCANMsg 27   */			msg[7] = (uint8)0xFF - crc;
   /* txCANMsg 28   */
...
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'OUT_CANTXLEVER_EVB_txCANMsg'
 ******************************************************************************/
