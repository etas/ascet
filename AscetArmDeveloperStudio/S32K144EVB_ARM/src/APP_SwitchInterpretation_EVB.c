...
#define _APP_MAXSWITCHPRESSTIME (self->APP_SWITCHINTERPRETATION_EVB_EFLASH->APP_MAXSWITCHPRESSTIME)
#define _APP_SwitchTimer_REF_ (&(self->APP_SwitchTimer))
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'APP_SWITCHINTERPRETATION_EVB_APP_SwitchState'
 * ----------------------------------------------------------------------------
 * model name:...................................'APP_SwitchState'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public APP_SwitchState (APP_SwitchIn::log;APP_SwitchFitted::log) return::udisc  */

uint8 APP_SWITCHINTERPRETATION_EVB_APP_SwitchState (
               struct APP_SWITCHINTERPRETATION_EVB * self,
   /* IN    */ boolean                               APP_SwitchIn,
   /* IN    */ boolean                               APP_SwitchFitted
   )
{
   /* APP_SwitchState: line #2  */
   /* return with expr from APP_SwitchState: min=0, max=3, hex=1phys+0, limit=(maxBitLength: false, assign: true), zero incl.=true  */
   return ((!APP_SwitchFitted) ? 3U : (((LIB_TIMERUP_EVB_LIB_Time(_APP_SwitchTimer_REF_, !APP_SwitchIn, SY_10MS) >= _APP_MAXSWITCHPRESSTIME) ? 0U : (((APP_SwitchIn) ? 2U : 1U)))));
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'APP_SWITCHINTERPRETATION_EVB_APP_SwitchState'
 ******************************************************************************/
