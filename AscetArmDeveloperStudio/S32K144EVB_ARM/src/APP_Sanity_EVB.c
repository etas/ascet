...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'APP_SANITY_EVB_SanityReturn'
 * ----------------------------------------------------------------------------
 * model name:...................................'SanityReturn'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public SanityReturn (APP_Sanity1::udisc;APP_Sanity2::udisc) return::udisc  */

uint8 APP_SANITY_EVB_SanityReturn (
   /* IN    */ uint8 APP_Sanity1,
   /* IN    */ uint8 APP_Sanity2
   )
{

   /* SanityReturn 1    */uint16 sanitycalc;
   /* SanityReturn 2    */
   /* SanityReturn 3    *//* Basic check to see if processor is able to perform simple operations */
   /* SanityReturn 4    *//* Sum the inputs - maximum 510 */
   /* SanityReturn 5    */sanitycalc = (uint16)   APP_Sanity1  +    APP_Sanity2 ;
   /* SanityReturn 6    *//* multiply by 4 - maximum 2040 */
   /* SanityReturn 7    */sanitycalc = sanitycalc * 4;
   /* SanityReturn 8    *//* Use double bitmask, and right shift to get return */
   /* SanityReturn 9    */return((uint8)(sanitycalc & 0x00FC) | (uint8)((sanitycalc & 0x0300) >> 8));
   /* SanityReturn 10   */
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'APP_SANITY_EVB_SanityReturn'
 ******************************************************************************/
