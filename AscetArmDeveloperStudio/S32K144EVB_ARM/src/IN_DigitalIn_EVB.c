...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'IN_DIGITALIN_EVB_getDigitalIn'
 * ----------------------------------------------------------------------------
 * model name:...................................'getDigitalIn'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public getDigitalIn (port::S32K144_Gpio) return::log  */

boolean IN_DIGITALIN_EVB_getDigitalIn (/* IN    */ uint8 port)
{

#ifdef PC
   /* getDigitalIn 2    */return(0);
   /* getDigitalIn 3    */
#endif 
   /* getDigitalIn 5    */
#ifdef S32K144EVB
   /* getDigitalIn 7    */
   /* getDigitalIn 8    */	return(HA_GetGPIOIn(   port ));
   /* getDigitalIn 9    */
#endif
   /* getDigitalIn 11   */
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'IN_DIGITALIN_EVB_getDigitalIn'
 ******************************************************************************/
