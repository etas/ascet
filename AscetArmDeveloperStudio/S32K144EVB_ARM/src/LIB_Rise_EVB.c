...
#define _LIB_Prev (self->LIB_RISE_EVB_IRAM->LIB_Prev)
#define _LIB_RiseLocal (self->LIB_RISE_EVB_IRAM->LIB_RiseLocal)
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'LIB_RISE_EVB_LIB_Rising'
 * ----------------------------------------------------------------------------
 * model name:...................................'LIB_Rising'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public LIB_Rising (LIB_Input::log) return::log  */

boolean LIB_RISE_EVB_LIB_Rising (
               struct LIB_RISE_EVB * self,
   /* IN    */ boolean               LIB_Input
   )
{
   /* LIB_Rising: source line #9:  LIB_RiseLocal = (LIB_Input && (!LIB_Prev));  */
   _LIB_RiseLocal = LIB_Input && (!_LIB_Prev);
   /* LIB_Rising: source line #10:  LIB_Prev = LIB_Input;  */
   _LIB_Prev = LIB_Input;
   /* LIB_Rising: source line #11:  return LIB_RiseLocal;  */
   return _LIB_RiseLocal;
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'LIB_RISE_EVB_LIB_Rising'
 ******************************************************************************/
