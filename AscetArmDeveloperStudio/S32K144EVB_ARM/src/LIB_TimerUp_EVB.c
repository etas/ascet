...
#define _LIB_TimeInternal (self->LIB_TIMERUP_EVB_IRAM->LIB_TimeInternal)
...
/******************************************************************************
 * BEGIN: DEFINITION OF METHOD 'LIB_TIMERUP_EVB_LIB_Time'
 * ----------------------------------------------------------------------------
 * model name:...................................'LIB_Time'
 * memory class:.................................'ICODE'
 * ---------------------------------------------------------------------------*/
/* public LIB_Time (LIB_Reset::log;LIB_DT::cont) return::cont  */

uint16 LIB_TIMERUP_EVB_LIB_Time (
   ...
   )
{
   ...
   /* LIB_Time: source line #9:  LIB_TimeInternal = (if LIB_Reset then 0.0 else(LIB_TimeInternal + LIB_DT));  */
   _t1uint32 = ((LIB_Reset) ? 0U : ((_LIB_TimeInternal) + (LIB_DT)));
   /* assignment to LIB_TimeInternal: min=0, max=65530, hex=1000phys+0, limit=(maxBitLength: true, assign: true), zero incl.=true  */
   _LIB_TimeInternal = (uint16)(((_t1uint32 <= 65530U) ? _t1uint32 : 65530U));
   /* LIB_Time: source line #10:  return LIB_TimeInternal;  */
   /* return with expr from LIB_Time: min=0, max=65530, hex=1000phys+0, limit=(maxBitLength: true, assign: true), zero incl.=true  */
   return _LIB_TimeInternal;
}
/* ----------------------------------------------------------------------------
 * END: DEFINITION OF METHOD 'LIB_TIMERUP_EVB_LIB_Time'
 ******************************************************************************/
