 ...
 * version 2.1
 *
 * This header file is used to define platform specific configurations
 * e.g.: how the delta time between two subsequent task executions shall be calculated.
 */
...
#define ASCET_DELTA_T_DYNAMIC 2
	...
	#error THESE CODE IS FOR EXAMPLE ONLY! DO NOT USE THIS CODE IN ECUS RUNNING IN ANY VEHICLE WITHOUT REVISING IT AGAINST YOUR REQUIREMENTS!
	#endif
